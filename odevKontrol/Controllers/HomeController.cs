...
namespace odevKontrol.Controllers
{
    public class HomeController : Controller
    {
            ...
            public HomeController(ILogger<HomeController> logger, HomeworkRepository homeworkRepository, IMapper mapper, UserRepository userRepository, IConfiguration config, INotyfService notyf, IFileProvider fileProvider)
            {
                _logger = logger;
            ...
            public async Task<IActionResult> Index()
            {
                ...
                homeworks = homeworks.Where(s => s.IsActive == true).ToList();
...
//        public HomeController(ILogger<HomeController> logger, HomeworkRepository homeworkRepository, IMapper mapper, INotyfService notyf)
//        {
//            _logger = logger;
//            _homeworkRepository = homeworkRepository;
//            _mapper = mapper;
